<?php
	...
	function tweetHTML($tweet, $tabs = 4){
		...
		$d  =   $t . "<div id=\"tweet-" . s($tweet['tweetid']) . "\" class=\"tweet" . (($tweet['type'] == 1) ? " reply" : "") . (($tweet['type'] == 2) ? " retweet" : "") . "\">\n" . 
				...
				$t . "\t<p class=\"text\"><a href=\"http://twitter.com/" . $tweet['screenname'] . "\"><strong>" . $tweet['screenname'] . "</strong> " . $tweet['realname'] . "</a><br>" . ($rt ? "<a class=\"rt\" href=\"http://twitter.com/" . $retweet['screenname'] . "\"><strong>" . $retweet['screenname'] . "</strong> " . $retweet['realname'] . "</a> " : "") . 
